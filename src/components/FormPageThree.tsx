  ...
  return (
    <>
      <div className="h-[70vh] md:h-auto shadow-xl md:shadow-none m-4 md:m-0 top-28 rounded-lg right-0 left-0 bg-white absolute md:static container-fluid flex flex-col py-12 md:py-6 pb-28 md:pb-0 px-6 md:px-20 lg:w-[35rem]">
        ...
        <div className="absolute bottom-4  md:relative md:bottom-[-4.9rem] flex justify-between md:left-0 md:right-0 right-4 left-4">
          <button
          ...
          <button
            className="ml-[10.3rem] md:ml-[13.75rem] bg-blue-900 text-white py-3 px-6 rounded-lg  text-center hover:bg-blue-700 transition-all duration-300 ease-in-out cursor-pointer"
            onClick={onNext}
          >
            Next Step
          </button>
